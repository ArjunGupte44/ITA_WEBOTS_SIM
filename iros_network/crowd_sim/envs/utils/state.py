...
FullState = namedtuple('FullState', ['cognitive_ability','skill_level','time','if_work','px', 'py', 'gx', 'gy', 'v', 'if_photograph'])
ObservableState = namedtuple('ObservableState', ['cognitive_ability','skill_level','time','if_work'])
# 观测空间：UAV,UGV运动状态，poi的探测情况，(vx_a,vy_a,vx_g,vy_g,poi_index)
