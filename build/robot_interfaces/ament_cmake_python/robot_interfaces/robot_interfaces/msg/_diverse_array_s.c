...
bool robot_interfaces__msg__diverse_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // poi_coords
    PyObject * field = PyObject_GetAttrString(_pymsg, "poi_coords");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->poi_coords.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'poi_coords'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * robot_interfaces__msg__diverse_array__convert_to_py(void * raw_ros_message)
{
  ...
  {  // poi_coords
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "poi_coords");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->poi_coords.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->poi_coords.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->poi_coords.size * sizeof(double));
      assert(data != NULL);
